    ...
    return (
        <footer className="bg-black text-white pt-16 pb-8 relative">
            ...
            <div className="container mx-auto px-4">
                {/* Newsletter Section */}
                <div className="bg-beige rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between mb-16 relative overflow-hidden border border-gold/20 shadow-xl">
                    ...
                    <div className="md:w-1/2 w-full max-w-md z-10">
                        <div className="flex bg-white rounded-full p-1 shadow-lg border border-gold/30">
                            <input
                                ...
                                className="flex-grow px-6 py-3 rounded-l-full text-gray-700 outline-none placeholder-gray-400"
                            />
                            <button className="bg-gold text-black px-8 py-3 rounded-full font-bold hover:bg-gold-dark transition-colors flex items-center shadow-md">
                                Subscribe
                            </button>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-8">
                    ...
                    <div>
                        <div className="mb-6 flex items-center space-x-2">
                            <img src={logo} alt="KhushaTech" className="h-8 w-auto filter invert brightness-0 invert-100" />
                            <span className="text-2xl font-bold text-white">KhushaTech</span>
                        </div>
